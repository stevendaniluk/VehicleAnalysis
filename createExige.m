function exige = createExige()
    ...
    exige.SVIC_ang_f = deg2rad(0.0); % TODO
    exige.SVIC_ang_r = deg2rad(30.0); % TODO
    ...
    % To compute spring perch positions need to subtract unsprung mass from each wheel
    W_us_f = 0.5 * exige.m_unsprung_f * exige.gravity;
    W_us_r = 0.5 * exige.m_unsprung_r * exige.gravity;
    exige = exige.setSpringPerchFromWheelLoads(x_fl, x_fr, x_rl, x_rr, ...
        W_FL - W_us_f, W_FR - W_us_f, W_RL - W_us_r, W_RR - W_us_r);
end
