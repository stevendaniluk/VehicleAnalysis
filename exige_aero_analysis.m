...
% analysis.plotAnalysisTimeData('AIR_SPEED', '.g', fig);
% 
% subplot(n, 1, 2);
...
analysis.plotTimeData('GROUND_SPEED', '-b', fig);
analysis.plotTimeData('AIR_SPEED', '--r', fig);
analysis.plotAnalysisTimeData('GROUND_SPEED', '.g', fig);
...
% subplot(n, 1, 5);
% analysis.plotTimeData('AERO_BALANCE', '-b', fig);
% ylim([-50, 150]);
...
% 
% subplot(n, 1, 1);
% analysis.plotAnalysisTimeData('GROUND_SPEED', '-b', fig);
% analysis.plotAnalysisTimeData('AIR_SPEED', '--r', fig);
% 
% subplot(n, 1, 2);
% analysis.plotAnalysisTimeData('AX', '-g', fig);
% analysis.plotAnalysisTimeData('AY', '-b', fig);
% analysis.plotAnalysisTimeData('AZ', '-r', fig);
% ylim([-5, 5]);
% 
% subplot(n, 1, 3);
% analysis.plotAnalysisTimeData('F_AERO_TOTAL', '-b', fig);
% analysis.plotAnalysisTimeData('F_AERO_FRONT', '--g', fig);
% analysis.plotAnalysisTimeData('F_AERO_REAR', '--r', fig);
% ylim([-100, 300]);
% 
% subplot(n, 1, 4);
% analysis.plotAnalysisTimeData('CL', '-b', fig);
% ylim([0, 2]);
% 
% subplot(n, 1, 5);
% analysis.plotAnalysisTimeData('AERO_BALANCE', '-b', fig);
% ylim([-50, 150]);
...
Cl_ref = 0.32;
A_ref = 1.70;
rho_air_mean = mean(analysis.analysis_data.RHO_AIR);
...
subplot(2, 2, 1);
hold on;
analysis.plotAnalysisData('AIR_SPEED', 'F_AERO_TOTAL', 'xb', fig);
plot(V_ref, F_aero_ref, 'r');
xlim(V_x_lim);
ylim(F_y_lim);

subplot(2, 2, 3);
analysis.plotAnalysisData('AIR_SPEED', 'CL', 'xm', fig);
xlim(V_x_lim);
ylim([-0.2, 1.2]);

subplot(2, 2, 2);
analysis.plotAnalysisData('AIR_SPEED', 'F_AERO_FRONT', 'xg', fig);
xlim(V_x_lim);
ylim(F_y_lim);

subplot(2, 2, 4);
analysis.plotAnalysisData('AIR_SPEED', 'F_AERO_REAR', 'xr', fig);
xlim(V_x_lim);
ylim(F_y_lim);
