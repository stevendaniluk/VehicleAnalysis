...
classdef MotecHandlerExige < MotecHandler
    methods
        function this = preProcessLogData(this)
            ...
            % Make sure lap number is always an int (it is sometimes doubles)
            this.log.Lap_Number.Value = int32(this.log.Lap_Number.Value);
        end

        function this = defineChannelMap(this)
            this = this.addChannelMappingEntry('LAP_NUMBER', 'Lap_Number');
