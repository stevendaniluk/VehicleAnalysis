classdef VehicleTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function longWeightTransferSuspensionForZeroAnti(this)
            ...
            this.verifyEqual(FL, -dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(FR, -dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(RL, dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(RR, dW_total / 4, 'AbsTol', 1e-6);
        end
        ...
        function longWeightTransferGeometricAndSuspensionTotal(this)
            ...
            this.verifyEqual(FL_geo + FL_susp, -dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(FR_geo + FR_susp, -dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(RL_geo + RL_susp, dW_total / 4, 'AbsTol', 1e-6);
            this.verifyEqual(RR_geo + RR_susp, dW_total / 4, 'AbsTol', 1e-6);
        end
